...
const loadGlobalStaticConfig = async function () {
	...
	globalConstants.SSECounselor = 'SSECounselor'
	...
	if (!globalConstants.counselorList.includes(globalConstants.SSECounselor)) {
		globalConstants.counselorList.push(globalConstants.SSECounselor)
	}

...
class SchoolsService extends SchoolsCommonService {
  async addSchool(req, res) {
    ...
    // ── NAYA LOGIC: assignedSELYears array setup before creating ──
    school.assignedSELYears = Array.isArray(school.assignedSELYears) ? school.assignedSELYears : []
  ...
  async updateSchool(req, res) {
    ...
    // ── NAYA LOGIC: Update karte waqt assignedSELYears set karein ──
    if (school.assignedSELYears !== undefined) {
      schoolRecord.assignedSELYears = Array.isArray(school.assignedSELYears) ? school.assignedSELYears : []
    }

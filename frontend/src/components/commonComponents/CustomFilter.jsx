...
const rolesArray = [
  {
    ...
    value: 'peeguCounselor', // API expected value
  },
  {
    label: 'School Counsellor',
    value: 'scCounselor', // API expected value
  },
  {
    label: 'Senior Leadership Team',
    value: 'ScPrincipal', // Exactly match case from backend
  },
  {
    label: 'School Special Educator', 
    value: 'SSECounselor', // Naya Role
  },
  {
    label: localizationConstants.all || 'All',
    value: localizationConstants.all || 'All',
  },
]

...
// const SelfAssessmentDashboard = lazy(() => import('./pages/initiations/selfAssessment/SelfAssessmentDashboard'))
...
// const Student360Dashboard = lazy(() => import('./pages/initiations/IEP/Student360Dashboard'))
...
//               {/* Render legacy List View on the base route */}
//               <Route path={routePaths.initiationsIEP} element={<Suspense fallback={loading}><StudentIEP /></Suspense>} />
              
//               {/* Note: The new Student 360 Dashboard requires a studentId param. Using the base or an override path here: */}
//               <Route path={`${routePaths.initiationsIEP}/:studentId`} element={<Suspense fallback={loading}><Student360Dashboard /></Suspense>} />
              
//               <Route path={routePaths.initiationsAddIEP} element={<Suspense fallback={loading}><AddIEP /></Suspense>} />
//               <Route path={`${routePaths.initiationsIEP}/:row_id/edit`} element={<Suspense fallback={loading}><EditIEP /></Suspense>} />
//               <Route path={routePaths.initiationsGandT} element={<Suspense fallback={loading}><GandT /></Suspense>} />
//               <Route path={routePaths.gandtTemplates} element={<Suspense fallback={loading}><GandTTemplateList /></Suspense>} />
//               <Route path={routePaths.gandtTemplateAdd} element={<Suspense fallback={loading}><GandTTemplateForm /></Suspense>} />
//               <Route path={routePaths.gandtTemplateEdit} element={<Suspense fallback={loading}><GandTTemplateForm /></Suspense>} />
...
const Login = lazy(() => import('./pages/login/Login'))
const AccountRecovery = lazy(() => import('./pages/accountRecovery/AccountRecovery'))
const CreateNewPassword = lazy(() => import('./pages/createNewPassword/CreateNewPassword'))
const Dashboard = lazy(() => import('./pages/dashboard/Dashboard'))
const ProtectedRoute = lazy(() => import('./ProtectedRoute'))
const DashboardContent = lazy(() => import('./pages/dashboardContent/DashboardContent'))
const PageNotFound = lazy(() => import('./components/PageNotFound'))
const ApplicationRoot = lazy(() => import('./components/ApplicationRoot'))
const Authentication = lazy(() => import('./components/Authentication'))
const Toast = lazy(() => import('./components/Toast'))
...
const ClassRooms = lazy(() => import('./pages/academic/classrooms/Classrooms'))
const Teachers = lazy(() => import('./pages/academic/teachers/Teachers'))
const IndividualCase = lazy(() => import('./pages/initiations/individualCase/IndividualCase'))

const Observation = lazy(() => import('./pages/initiations/observation/Observation'))
const Baseline = lazy(() => import('./pages/initiations/baseline/Baseline'))
const StudentBaseline = lazy(() => import('./pages/initiations/baseline/StudentBaselineReport'))
const SelfAssessmentBaseline = lazy(() => import('./pages/initiations/baseline/SelfAssessmentBaseline'))
const SelfAssessmentDashboard = lazy(() => import('./pages/initiations/selfAssessment/SelfAssessmentDashboard'))

const Sel = lazy(() => import('./pages/initiations/SELCurriculumTracker/SEL'))
const StudentCope = lazy(() => import('./pages/assessment/StudentCope/StudentCope'))
const TeacherIRI = lazy(() => import('./pages/assessment/teacherIRI/TeacherIRI'))
const TeacherIRITeachersList = lazy(() => import('./pages/assessment/teacherIRI/TeacherIRITeachersList'))
const TeacherIRIAssessment = lazy(() => import('./pages/assessment/teacherIRI/TeacherIRIAssessment'))

const SafeSpaces = lazy(() => import('./pages/newAssesment/safeSpaces/SafeSpaces'))
const SELCompetency = lazy(() => import('./pages/newAssesment/SELCompetency/SELAssessment'))
const Pulse = lazy(() => import('./pages/newAssesment/pulse/Pulse'))
const HeartEducators = lazy(() => import('./pages/newAssesment/heartEducators/Heart'))
const TeacherProfilingAssessment = lazy(() => import('./pages/assessment/TeacherProfiling/TeacherProfilingAssessment'))
const StudentWellBeing = lazy(() => import('./pages/assessment/studentWellBeing/StudentWellBeing'))
const GandTTemplateList = lazy(() => import('./pages/gandt/templates/GandTTemplateList'))
const GandTTemplateForm = lazy(() => import('./pages/gandt/templates/GandTTemplateForm'))
const GandTTemplateView = lazy(() => import('./pages/gandt/templates/GandTTemplateView'))
const GandTAssignmentList = lazy(() => import('./pages/gandt/assignments/GandTAssignmentList'))
const SendChecklist = lazy(() => import('./pages/initiations/sendCheckList/SendCheckList'))
const StudentIEP = lazy(() => import('./pages/initiations/IEP/StudentIEP'))

// 🟢 AI IEP Route Components
...
{/* 🟢 2. Phir Dashboard View (Jahan PDF upload hoti hai) */}
<Route path={`${routePaths.aiIep}/:studentId`} element={<Suspense fallback={loading}><AIIEPDashboard /></Suspense>} />              
              <Route path={routePaths.initiationsAddIEP} element={<Suspense fallback={loading}><AddIEP /></Suspense>} />
              <Route path={`${routePaths.initiationsIEP}/:row_id/edit`} element={<Suspense fallback={loading}><EditIEP /></Suspense>} />
              <Route path={routePaths.initiationsGandT} element={<Suspense fallback={loading}><GandT /></Suspense>} />
              <Route path={routePaths.gandtTemplates} element={<Suspense fallback={loading}><GandTTemplateList /></Suspense>} />

...
//   const [inputs, setInputs] = useState({ ...initialState, assignedSELYears: [] })
...
//   // ── NAYA LOGIC: Generate 'Year 1' to 'Year 10' list ──
//   const selYearsOptions = useMemo(() => {
...
//           Object.keys(inputs).includes(key) || key === 'assignedSELYears',
//         )
//       : []
//     if (keys.length > 0) {
//       const obj = {}
...
//       // Ensure assignedSELYears defaults to empty array if not present
//       if (!obj.assignedSELYears) obj.assignedSELYears = []
...
//           value={
//             inputs?.academicYear ||
//             getCurrentAcademicYearId(academicYears) ||
//             ''
//           }
//           placeholder={`${localizationConstants.select} ${localizationConstants.academicYear}`}
//           onChange={(e) => {
...
//             minWidth: '80px', 
//             width: '390px',
//             // NAYA CSS FIX: Box ko auto-expand karne ke liye
...
//             }
//           }}
//           fieldSx={{ height: 'auto', minHeight: '44px' }} 
//           value={inputs?.assignedSELYears || []}
//           placeholder={`Select Assigned SEL Years`}
//           onChange={(e) => {
//             handleInputs({
//               target: { name: 'assignedSELYears', value: e },
//             })
//           }}
//           options={selYearsOptions}
//           disabled={readOnly}
//         />
//       </Box>
...
const SchoolForm = ({
  ...
  // ✅ NAYA FIX 1: Current Year ka logic calculate karna 
  const currentYearString = getCurrentAcademicYear();
  const activeYearObj = academicYears?.find(ay => ay.academicYear === currentYearString);
  const fallbackYearId = activeYearObj?._id || '';
    ...
    <Box sx={{ pb: '30px', overflowX: 'hidden' }}>
      ...
      <Box sx={{ mt: '24px' }}>
        ...
        <CustomAutocompleteNew
          ...
          value={rowData?.lastPromotionAcademicYear || fallbackYearId}

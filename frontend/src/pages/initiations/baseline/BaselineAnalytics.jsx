		...
		<Box ref={captureUIRef}>
			...
			{isAllSchool(selectedDropdownData.schools) ? (
				...
				{/* --------------------- KPI Summary Cards with School Name ---------------- */}
                    ...
                    {/* 🟢 NEW FEATURE: AI Class Insights (Coming Soon) Card added for client discussion */}
                    <Box sx={{ mt: '16px', mb: '16px', display: 'flex', width: '100%' }}>
                        <Box 
                            sx={{ 
                                width: '100%',
                                background: 'linear-gradient(135deg, #F8FAFC 0%, #EFF6FF 100%)', // Subtle AI gradient
                        ...
                        >
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: '12px' }}>
                                {/* Using a standard star icon if AutoAwesomeIcon is not imported */}
                                <Typography sx={{ fontSize: '20px', mr: '8px' }}>✨</Typography>
                                <Typography variant={typographyConstants.h5} sx={{ fontWeight: 600, color: '#1E293B', fontSize: '18px' }}>
                                    AI Class Insights & Trend Forecasting
                                </Typography>
                            </Box>

                            <Typography variant={typographyConstants.body} sx={{ color: '#64748B', lineHeight: 1.5, mb: '16px', maxWidth: '80%' }}>
                                Macro-level predictive analytics engine. Automatically identify class-wide resilience clusters, systemic risk factors, escalation trends, and generate domain-level intervention strategies based on aggregate baseline data.
                            </Typography>

                            <Box sx={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                                <Typography sx={{ fontSize: '12px', backgroundColor: '#DBEAFE', color: '#1D4ED8', px: '12px', py: '4px', borderRadius: '12px', fontWeight: 600 }}>
                                    Cluster Detection
                                </Typography>
                                <Typography sx={{ fontSize: '12px', backgroundColor: '#E0E7FF', color: '#4338CA', px: '12px', py: '4px', borderRadius: '12px', fontWeight: 600 }}>
                                    Trend Forecasting
                                </Typography>
                                <Typography sx={{ fontSize: '12px', backgroundColor: '#F3E8FF', color: '#5B21B6', px: '12px', py: '4px', borderRadius: '12px', fontWeight: 600 }}>

...
const Counsellors = () => {
    ...
    switch (permission) {
      case localizationConstants.admin:
      case 'admin':
      case 'Admin':
        return localizationConstants.admin || 'Admin';
        
      case localizationConstants.superAdmin:
      case 'superAdmin':
      case 'SuperAdmin':
        return localizationConstants.superAdminn || 'Super Admin';
        
      case localizationConstants.peeguCounsellor: 
      case 'peeguCounselor':
        return 'MyPeegu Experts';
        
      case localizationConstants.schoolCounsellor: 
      case 'scCounselor':
      case 'counselor': 
        return 'School Counsellor';
        
      case 'SSECounselor':
        return 'School Special Educator';
        
      case localizationConstants.teacher:
      case 'teacher':
      case 'Teacher':
        return localizationConstants.teacher || 'Teacher';
        
      case localizationConstants.pricipal: 
      case 'scPrincipal':
      case 'ScPrincipal': 
      case 'principal': 
      case 'Principal': 
      ...
      default:
        console.log("Unknown role label received from backend:", permission);
        return 'Unknown'; 
    }
  }
	...
	return (
      ...
      {allCounsellors?.data?.length > 0 && (
        ...
        >
          {/* overflowX: 'auto'  */}
          <Box sx={{ flex: 1, overflowX: 'auto', ...tableStyles.scrollWrapper }}>
            <Table

...
const EditCounsellorDrawer = ({
	...
	return (
		...
		{/* Footer */}
        <Box sx={{ ...counsellorStyles.drawerFooterSx, width: '100%', boxSizing: 'border-box' }}>
          {isEditButtonClicked ? (
            <Box sx={{ display: 'flex', gap: '12px', width: '100%' }}>
              {/* Cancel Button Container - 50% width */}
              <Box sx={{ width: '50%' }}>
                <CustomButton
                  text={localizationConstants.cancel}
                  typoSx={{ color: 'text.primary' }}
                  sx={{
                    width: '100%', // 100% of its 50% parent
                    height: '44px',
                    borderRadius: '8px',
              ...
              {/* Submit Button Container - 50% width */}
              <Box sx={{ width: '50%' }}>
                <CustomButton
            ...
            <Box sx={{ display: 'flex', gap: '12px', alignItems: 'center', width: '100%' }}>
              <Box
                sx={{
                  ...
                  flexShrink: 0, // Prevents icon button from shrinking
                  '&:hover': {
